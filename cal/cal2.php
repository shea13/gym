...
<table  width="200" border="0"  style="position:relative;" cellpadding="1" cellspacing="15" >
 ...
 <tr>
  ...
  <tr>
<!-- td1 -->    <td<?php echo $dimTd;?> ondblclick="javascript:change(1)"><div class="<?php if((1+$x)<=9) {print "divChiffre1Img1";} else {print "divChiffre2Img1";}?>"><?php if((1+$x)>0) print (1+$x); else {print $blanc;}?></div><div class="<?php if((1+$x)<=9) {print "divImg1";} else {print "divImg2";}?>"><!-- img --><img src="retaille/<?php print str_pad($moisEncours, 2, "0", STR_PAD_LEFT) . "/cal" . ($cpt++)?>.jpg"<?php echo $dimImg;?> /><!-- img --></div></td>
<!-- td2 -->    <td<?php echo $dimTd;?> ondblclick="javascript:change(2)"><div class="<?php if((2+$x)<=9) {print "divChiffre1Img1";} else {print "divChiffre2Img1";}?>"><?php if((2+$x)>0) print (2+$x); else {print $blanc;}?></div>  <div class="<?php if((2+$x)<=9) {print "divImg1";} else {print "divImg2";}?>"><!-- img --><img src="retaille/<?php print str_pad($moisEncours, 2, "0", STR_PAD_LEFT) . "/cal" . ($cpt++)?>.jpg"<?php echo $dimImg;?> /><!-- img --></div></td>
...
<!-- td4 -->    <td<?php echo $dimTd;?> ondblclick="javascript:change(4)"><div class="<?php if((4+$x)<=9) {print "divChiffre1Img1";} else {print "divChiffre2Img1";}?>"><?php if((4+$x)>0) print (4+$x); else {print $blanc;}?></div><div class="<?php if((4+$x)<=9) {print "divImg1";} else {print "divImg2";}?>"><!-- img --><img src="retaille/<?php print str_pad($moisEncours, 2, "0", STR_PAD_LEFT) . "/cal" . ($cpt++)?>.jpg"<?php echo $dimImg;?> /><!-- img --></div></td>
...
<!-- td14 -->    <td<?php echo $dimTd;?> ondblclick="javascript:change(14)"><div class="<?php if((14+$x)<=9) {print "divChiffre1Img1";} else {print "divChiffre2Img1";}?>"><?php if((14+$x)>0) print (14+$x); else {print $blanc;}?></div><div class="<?php if((14+$x)<=9) {print "divImg1";} else {print "divImg2";}?>"><!-- img --><img src="retaille/<?php print str_pad($moisEncours, 2, "0", STR_PAD_LEFT) . "/cal" . ($cpt++)?>.jpg"<?php echo $dimImg;?> /><!-- img --></div></td>
  </tr>
...
<!-- td17 -->    <td<?php echo $dimTd;?> ondblclick="javascript:change(17)"><div class="<?php if((17+$x)<=9) {print "divChiffre1Img1";} else {print "divChiffre2Img1";}?>"><?php if((17+$x)>0) print (17+$x); else {print $blanc;}?></div><div class="<?php if((17+$x)<=9) {print "divImg1";} else {print "divImg2";}?>"><!-- img --><img src="retaille/<?php print str_pad($moisEncours, 2, "0", STR_PAD_LEFT) . "/cal" . ($cpt++)?>.jpg"<?php echo $dimImg;?> /><!-- img --></div></td>
...
<!-- td20 -->    <td<?php echo $dimTd;?> ondblclick="javascript:change(20)"><div class="<?php if((20+$x)<=9) {print "divChiffre1Img1";} else {print "divChiffre2Img1";}?>"><?php if((20+$x)>0) print (20+$x); else {print $blanc;}?></div><div class="<?php if((20+$x)<=9) {print "divImg1";} else {print "divImg2";}?>"><!-- img --><img src="retaille/<?php print str_pad($moisEncours, 2, "0", STR_PAD_LEFT) . "/cal" . ($cpt++)?>.jpg"<?php echo $dimImg;?> /><!-- img --></div></td>
...
<!-- td28 -->    <td<?php echo $dimTd;?> ondblclick="javascript:change(28)"><div class="<?php if((28+$x)<=9) {print "divChiffre1Img1";} else {print "divChiffre2Img1";}?>"><?php if(((28+$x)>0)&&((28+$x)<=$nbJourDsLeMois[$moisEncours])) print (28+$x); else {print $blanc2chiffres;}?></div><div class="<?php if((28+$x)<=9) {print "divImg1";} else {print "divImg2";}?>"><!-- img --><img src="carre.jpg"<?php echo $dimImg;?> /><!-- img --></div></td>
  ...
  <tr>
<!-- td29 -->    <td<?php echo $dimTd;?> ondblclick="javascript:change(29)"><div class="<?php if((29+$x)<=9) {print "divChiffre1Img1";} else {print "divChiffre2Img1";}?>"><?php if(((29+$x)>0)&&((29+$x)<=$nbJourDsLeMois[$moisEncours])) print (29+$x); else {print $blanc2chiffres;}?></div><div class="<?php if((29+$x)<=9) {print "divImg1";} else {print "divImg2";}?>"><!-- img --><img src="retaille/<?php print str_pad($moisEncours, 2, "0", STR_PAD_LEFT) . "/cal" . ($cpt++)?>.jpg"<?php echo $dimImg;?> /><!-- img --></div></td>
...
<!-- td32 -->    <td<?php echo $dimTd;?> ondblclick="javascript:change(32)"><div class="<?php if((32+$x)<=9) {print "divChiffre1Img1";} else {print "divChiffre2Img1";}?>"><?php if(((32+$x)>0)&&((32+$x)<=$nbJourDsLeMois[$moisEncours])) print (32+$x); else {print $blanc2chiffres;}?></div><div class="<?php if((32+$x)<=9) {print "divImg1";} else {print "divImg2";}?>"><!-- img --><img src="retaille/<?php print str_pad($moisEncours, 2, "0", STR_PAD_LEFT) . "/cal" . ($cpt++)?>.jpg"<?php echo $dimImg;?> /><!-- img --></div></td>

<!-- td33 -->    <td<?php echo $dimTd;?> ondblclick="javascript:change(33)"><div class="<?php if((33+$x)<=9) {print "divChiffre1Img1";} else {print "divChiffre2Img1";}?>"><?php if(((33+$x)>0)&&((33+$x)<=$nbJourDsLeMois[$moisEncours])) print (33+$x); else {print $blanc2chiffres;}?></div><div class="<?php if((33+$x)<=9) {print "divImg1";} else {print "divImg2";}?>"><!-- img --><img src="retaille/<?php print str_pad($moisEncours, 2, "0", STR_PAD_LEFT) . "/cal" . ($cpt++)?>.jpg"<?php echo $dimImg;?> /><!-- img --></div></td>
<!-- td34 -->    <td<?php echo $dimTd;?> ondblclick="javascript:change(34)"><div class="<?php if((34+$x)<=9) {print "divChiffre1Img1";} else {print "divChiffre2Img1";}?>"><?php if(((34+$x)>0)&&((34+$x)<=$nbJourDsLeMois[$moisEncours])) print (34+$x); else {print $blanc2chiffres;}?></div><div class="<?php if((34+$x)<=9) {print "divImg1";} else {print "divImg2";}?>"><!-- img --><img src="retaille/<?php print str_pad($moisEncours, 2, "0", STR_PAD_LEFT) . "/cal" . ($cpt++)?>.jpg"<?php echo $dimImg;?> /><!-- img --></div></td>

<!-- td35 -->    <td<?php echo $dimTd;?> ondblclick="javascript:change(35)"><div class="<?php if((35+$x)<=9) {print "divChiffre1Img1";} else {print "divChiffre2Img1";}?>"><?php if(((35+$x)>0)&&((35+$x)<=$nbJourDsLeMois[$moisEncours])) print (35+$x); else {print $blanc2chiffres;}?></div><div class="<?php if((35+$x)<=9) {print "divImg1";} else {print "divImg2";}?>"><!-- img --><img src="retaille/<?php print str_pad($moisEncours, 2, "0", STR_PAD_LEFT) . "/cal" . ($cpt++)?>.jpg"<?php echo $dimImg;?> /><!-- img --></div></td>
  </tr>
