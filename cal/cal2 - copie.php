...
float:left; position:absolute; top: 85px; left: 80px; z-index:1000;
}
 
  	.divImg1 {float:left; position:relative; top: 1px; left: -6px; z-index:0; filter:Alpha(opacity=100);-moz-opacity:1;opacity: 1;}
	.divImg2 {float:left; position:relative; top: -6px; left: 0px; z-index:0; filter:Alpha(opacity=100);-moz-opacity:1;opacity: 1;}
	...
	.divChiffre2Img1{float:left; position:relative; top: 10px; left:8px; z-index:1; filter:Alpha(opacity=100);-moz-opacity:1;opacity: 1;}
  </style>
</head>
