...
<div id="">
  ...
  <div id="droit" class="liensDroit">
    <ul >
      <li> <img src="/images/fos.gif" style="border: 0px none;" alt="Fos-sur-mer" title="Fos-sur-mer" height="15" width="15">&nbsp;&nbsp;<a href="http://www.fos-sur-mer.fr/-Actualite-.html" target="_blank">Actualit&eacute;s &agrave; Fos sur mer</a> </li>
  ...
  <div class="blanc"></div>
  <?php if(!isset($pasDactualite)) {?>
  <div class="contenuAgenda">
    <div class="BordureInterieurAgenda titreAgenda">
      <h2 >Actualit&eacute;s</h2>
    </div>
    <div class="BordureInterieurAgenda">
      <div id="printActu">
      
        <?php 
		$nbtotal = 1; 
		
			include($_SERVER['DOCUMENT_ROOT']."/inc/actualites.php");
			if(!isset($d))
			{
			    $d=0;
			}
    ...
    <div class="pages">
      <div class="suivante"> <a href="#" onclick="javascript:actusSuivantes(-1); return false;"><img src="/images/triangleG.jpg" alt="pr&eacute;c&eacute;dent"></a>&nbsp;<span id="numPage"><?php echo $dPlus;?>/<?php echo $pageTotal;?></span>&nbsp;<a href="#" onclick="javascript:actusSuivantes(1); return false;"><img src="/images/triangleD.jpg" alt="suivant"></a> </div>
      <div class="csclear"></div>
    </div>
  </div>
  <?php 
