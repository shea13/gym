  ...
  <div id="container">
    ...
    <div id="divDeGauche"> <br/>
      ...
      <div class="cadre gradient" style="font-size:12px">
        <div class="content">
          <h1>Spectacle de fin d'année 2012-2013</h1>
         <iframe width="640" height="360" src="http://www.youtube.com/embed/5lhN9y8b8w8?feature=player_embedded" frameborder="0" allowfullscreen></iframe>
