...
<div id ="grandContainer">
  ...
  <div id="container">
    ...
    <div id="divDeGauche"><br/><br/>
    <div class="cadre gradient"> 	
    Si vous souhaitez participer à la vie du club contactez nous par mail, téléphone, ou pendant les heures de cours. 
<br/>Nous acceptons toujours les bonnes volontés :-)
      </div>
		  </div>
		  <div id="divDeDroite"><?php include("divr.php");?>
        	</div>
    <br class="clearBoth" />
    <?php  
