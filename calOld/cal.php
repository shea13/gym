...
td {
	...
	table { 
  	padding:10px; margin:10px;font-size:12px; text-align:center; vertical-align: middle; width:800px
}
...
<?php 
$espace = "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
$dimTd =' width="84" height="56"';
$dimImg =' width="84" height="56"';
?>
<table  width="200" border="0"  style="position:relative;" cellpadding="1" cellspacing="15" >
 <tr>
    <th colspan="7" scope="col"  style="font-size:12px; font-weight:bold; text-align:left; vertical-align:top; background-color:#663333; color:#FFFFFF">&nbsp;&nbsp;&nbsp;Lundi&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php print $espace;?>Mardi&nbsp;&nbsp;<?php print $espace;?>&nbsp;&nbsp;Mercredi<?php print $espace;?>Jeudi<?php print $espace;?>&nbsp;Vendredi<?php print $espace;?>Samedi<?php print $espace;?>Dimanche</th>
  </tr>
  <tr>
...
<!-- td11 -->    <td<?php echo $dimTd;?> ondblclick="javascript:change(11)"><div class="<?php if((11+$x)<=9) {print "divChiffre1Img1";} else {print "divChiffre2Img1";}?>"><?php if((11+$x)>0) print (11+$x); else {print $blanc;}?></div><div class="<?php if((11+$x)<=9) {print "divImg1";} else {print "divImg2";}?>"><!-- img --><img src="retaille/<?php print str_pad($moisEncours, 2, "0", STR_PAD_LEFT) . "/cal" . ($cpt++)?>.jpg"<?php echo $dimImg;?> /><!-- img --></div></td>
...
<!-- td27 -->    <td<?php echo $dimTd;?> ondblclick="javascript:change(27)"><div class="<?php if((27+$x)<=9) {print "divChiffre1Img1";} else {print "divChiffre2Img1";}?>"><?php if(((27+$x)>0)&&((27+$x)<=$nbJourDsLeMois[$moisEncours])) print (27+$x); else {print $blanc2chiffres;}?></div><div class="<?php if((27+$x)<=9) {print "divImg1";} else {print "divImg2";}?>"><!-- img --><img src="retaille/<?php print str_pad($moisEncours, 2, "0", STR_PAD_LEFT) . "/cal" . ($cpt++)?>.jpg"<?php echo $dimImg;?> /><!-- img --></div></td>
...
<!-- td31 -->    <td<?php echo $dimTd;?> ondblclick="javascript:change(31)"><div class="<?php if((31+$x)<=9) {print "divChiffre1Img1";} else {print "divChiffre2Img1";}?>"><?php if(((31+$x)>0)&&((31+$x)<=$nbJourDsLeMois[$moisEncours])) print (31+$x); else {print $blanc2chiffres;}?></div><div class="<?php if((31+$x)<=9) {print "divImg1";} else {print "divImg2";}?>"><!-- img --><img src="retaille/<?php print str_pad($moisEncours, 2, "0", STR_PAD_LEFT) . "/cal" . ($cpt++)?>.jpg"<?php echo $dimImg;?> /><!-- img --></div></td>
...
<br/>
<div style="position:relative; left:650px; top:10px"><?php print $mois[$moisEncours]." ".$anEnCours;?></div>
<br/>
<div style="position:relative; left:650px; top:10px">
Mettre le fond: 
